...
3. `showcase.json`의 대표 프로젝트 여부와 노출 순서를 적용합니다.
4. GitHub 기본 정보와 설정 파일의 사용자 지정 정보를 합칩니다.
5. API 요청이 실패하면 마지막 정상 데이터 또는 설정 파일의 기본 데이터를 사용합니다.
