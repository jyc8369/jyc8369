...
This page contains the detailed visual profile. Each section uses theme-aware SVG assets from [`assets/profile/`](../assets/profile/).
...
[↑ Back to top](#profile-details) · [All repositories](https://github.com/jyc8369?tab=repositories)
